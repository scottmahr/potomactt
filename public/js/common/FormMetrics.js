...
app.factory('FormMetrics', ['$rootScope','FormGlobals', 'FormState' ,
    ...
    service.getMetricForIdx = function(idx,liftTypeID){
        //console.log('userMetrics',fs.userMetrics)
        ...
        //console.log('finalMetric',metric)
    ...
    service.setCustomMetric = function(metricKey,data){
        //console.log('seting custom metrics:'+metricKey+":"+JSON.stringify(data))
        ...
        if(!_.has(fs.userMetrics,metricKey)){
            ...
            //console.log('what we have',JSON.stringify(fs.userMetrics[metricKey]));
            //console.log('what we are putting in',JSON.stringify(data));
            fs.userMetrics[metricKey] = _.extend(fs.userMetrics[metricKey],data);
            //console.log('output',JSON.stringify(fs.userMetrics[metricKey]));
